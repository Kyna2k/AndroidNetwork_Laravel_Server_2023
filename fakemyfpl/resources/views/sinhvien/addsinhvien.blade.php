...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Thêm </span>Sinh viên</h4>
    ...
    <div class="row">
      <div class="col-xl">
        <div class="card mb-4">
          ...
          <div class="card-body">
            <form action="{{ route('sinhvien.addSinhVien') }}" method="post" enctype="multipart/form-data">
              ...
              <div class="mb-3">
                ...
                <input type="text" value="{{ old('masinhvien') }}" name="masinhvien" class="form-control" id="basic-default-fullname" placeholder="PS23156" />
                @error('masinhvien')
              ...
              <div class="mb-3 mt-3">
                ...
                <input type="text" value="{{ old('hoten') }}" name="hoten" class="form-control" id="basic-default-company" placeholder="Phan Thanh Tèo" />
                @error('hoten')
                <span style="color: red;">{{ $message }}</span>
                @enderror  
            </div>
            <div class="mb-3 mt-3">
                ...
                <input type="text" value="{{ old('email') }}" name="email" class="form-control" id="basic-default-company" placeholder="huyps@fpt.edu.vn" />
                @error('email')
                <span style="color: red;">{{ $message }}</span>
                @enderror  
            </div>
            <div class="mb-3 mt-3">
                ...
                <input type="text" value="{{ old('khoa') }}" name="khoa" class="form-control" id="basic-default-company" placeholder="MD17304" />
                @error('khoa')
                <span style="color: red;">{{ $message }}</span>
                @enderror  
            </div>
