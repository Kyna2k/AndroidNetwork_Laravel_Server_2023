        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            <form action="{{ route('giaovien.store') }}" method="post" enctype="multipart/form-data">
              ...
              <div class="mb-3">
                <label class="form-label" for="basic-default-fullname">Tên giáo viên</label>
                <input type="text" value="{{ old('tengiaovien') }}" name="tengiaovien" class="form-control" id="basic-default-fullname" placeholder="CP17307" />
                @error('tengiaovien')
