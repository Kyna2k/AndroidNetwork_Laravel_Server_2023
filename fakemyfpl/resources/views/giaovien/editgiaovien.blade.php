...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Thêm </span>Giáo viên</h4>
        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            <form action="{{ route('giaovien.update',['id'=>$giaovien->id]) }}" method="post" enctype="multipart/form-data">
              ...
              <div class="mb-3">
                <label class="form-label" for="basic-default-fullname">Mã giáo viên</label>
                <input type="text" value="{{ old('tengiaovien') ?? $giaovien->tengiaovien}}" name="tengiaovien" class="form-control" id="basic-default-fullname" placeholder="CP17307" />
                @error('tengiaovien')
              ...
              <div class="mb-3">
                ...
                <img src="{{ $giaovien->hinhanh }}" style="object-fit: contain;" width="100%" id="ReviewImage" />
