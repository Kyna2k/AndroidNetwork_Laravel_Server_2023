    ...
    <div class="row">
      <div class="col-xl">
        <div class="card mb-4">
          ...
          <div class="card-body">
            <form action="{{ route('monhoc.store') }}" method="post" enctype="multipart/form-data">
              ...
              <div class="mb-3">
                ...
                <input type="text" value="{{ old('mamon') }}" name="mamon" class="form-control" id="basic-default-fullname" placeholder="CP17307" />
                @error('mamon')
                    <span style="color: red;">{{ $message }}</span>
                @enderror
              </div>
              <div class="mb-3">
                <label class="form-label" for="basic-default-fullname">Tên môn học</label>
                <input type="text" value="{{ old('tenmon') }}" name="tenmon" class="form-control" id="basic-default-fullname" placeholder="CP17307" />
                @error('tenmon')
                    <span style="color: red;">{{ $message }}</span>
                @enderror
              </div>
