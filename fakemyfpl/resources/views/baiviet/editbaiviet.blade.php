...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Cập nhật </span> bài viết</h4>
    ...
    <div class="row">
      <div class="col-xl">
        <div class="card mb-4">
          ...
          <div class="card-body">
            <form action="{{ route('baiviet.update',["id"=>$baiviet->id]) }}" method="post">
              ...
              <div class="mb-3">
                ...
                <input type="text" value="{{ old('tieude')??$baiviet->tieude }}" name="tieude" class="form-control" id="basic-default-fullname" placeholder="CP17307" />
                @error('tieude')
              ...
              <div class="mb-3">
                ...
                <textarea type="text"  name="noidung" class="form-control" id="basic-default-fullname" placeholder="CP17307" >{{ old('noidung') ?? $baiviet->noidung }}</textarea>
                @error('noidung')
                    <span style="color: red;">{{ $message }}</span>
                @enderror
              </div>
              ...
              <div class="mb-3">
                ...
                <select class="form-select" name="id_loaibaiviet" id="exampleFormControlSelect1" aria-label="Default select example">
                  ...
                  @if ($baiviet->id_loaibaiviet === $item->id)
                  <option value="{{ $item->id }}" selected>{{ $item->theloai }}</option>
                  @else
              ...
              <div class="mb-3">
                ...
                <input type="text" value="{{ old('tennguoidang') ?? $baiviet->tennguoidang}}" name="tennguoidang" class="form-control" id="basic-default-fullname" placeholder="CP17307" />
                @error('tennguoidang')
                    <span style="color: red;">{{ $message }}</span>
                @enderror
              </div>
