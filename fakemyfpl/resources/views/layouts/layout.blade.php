...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ asset('image/favicon/favicon.ico') }}" />
        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo" style="justify-content: center">
                    <a href="index.html" class="app-brand-link">
                        <span class="app-brand-logo demo">
                           <img src="{{ asset('image/logo_myfpl.png') }}" style="object-fit: contain" width="100%" height="45px"/>
                        </span>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <!-- Forms & Tables -->
                    <li class="menu-header small text-uppercase"><span class="menu-header-text">Tool</span></li>
                    <!-- Forms -->
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                                    <div class="avatar avatar-online">
                                        <img src="{{ asset('image/avatars/1.png') }}" alt class="w-px-40 h-auto rounded-circle" />
                                    </div>
                                </a>
