...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Sửa </span>Lớp</h4>
    ...
    <div class="row">
      <div class="col-xl">
        <div class="card mb-4">
          ...
          <div class="card-body">
            <form action="{{ route('lop.update',['id'=>$lop->id]) }}" method="post">
              ...
              <div class="mb-3">
                ...
                <input type="text" value="{{ old('malop')??$lop->malop }}" name="malop" class="form-control" id="basic-default-fullname" placeholder="CP17307" />
                @error('malop')
